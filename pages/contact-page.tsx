...
const Contact = (): JSX.Element => {
  return (
    <Layout title='Contact'>
      <div className='bg-whiete text-center shadow-xl p-8 w-80 rounded'>
        <div className='mt-4'>
        ...
        <div className='mt-4'>
          ...
          <p className='text-xs mt-2 text-gray-600'>Meguro, Tokyo</p>
          <p className='font-bold mt-3'>E-mail</p>
          <p className='text-xs mt-2 text-gray-600'>sample@sample.com</p>
          <p className='font-bold mt-3'>Phone</p>
          <p className='text-xs mt-2 text-gray-600'>090-xxxx-xxxx</p>
        </div>
